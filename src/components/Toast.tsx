...
export default function Toast({
  ...
  const getIcon = () => {
    switch (type) {
      case 'success':
        return (
          <svg className="w-5 h-5 mr-2 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  return (
    ...
    >
      ...
      >
        ...
        {showCloseButton && (
          <button
            className="ml-3 text-gray-400 hover:text-gray-600 focus:outline-hidden"
            onClick={(e) => {
              e.stopPropagation();
              handleClose();
            }}
