          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-2">
              <a
                ...
                className="flex items-center px-3 py-1.5 text-sm bg-linear-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white rounded-md transition-colors focus:outline-hidden focus:ring-2 focus:ring-blue-500"
              >
