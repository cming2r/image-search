  ...
  return (
    <>
      <div className="mt-12 bg-white p-6 rounded-lg shadow-sm">
        <h2 className="text-xl font-bold mb-3">{imageUrlContentTranslations.howToUse.title[lang]}</h2>
      ...
      <div className="mt-8 bg-white p-6 rounded-lg shadow-sm">
        <h2 className="text-xl font-bold mb-3">{imageUrlContentTranslations.whatIs.title[lang]}</h2>
      ...
      <div className="mt-8 bg-white p-6 rounded-lg shadow-sm">
        <h2 className="text-xl font-bold mb-3">{imageUrlContentTranslations.features.title[lang]}</h2>
      ...
      <div className="mt-8 bg-white p-6 rounded-lg shadow-sm">
        <h2 className="text-xl font-bold mb-3">{imageUrlContentTranslations.useCases.title[lang]}</h2>
      ...
      <div className="mt-8 bg-white p-6 rounded-lg shadow-sm">
        <h2 className="text-xl font-bold mb-3">{imageUrlTranslations.faq.title[lang]}</h2>
      ...
      <div className="mt-8 bg-white p-6 rounded-lg shadow-sm mb-8">
        <h2 className="text-xl font-bold mb-3">{imageUrlContentTranslations.whyChooseUs.title[lang]}</h2>
