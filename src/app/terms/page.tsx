    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <div className="container mx-auto max-w-4xl px-4 py-8">
          <h1 className="text-3xl font-bold mb-6 text-center">使用條款</h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3">1. 服務內容</h2>
            <p>本網站提供以下功能：</p>
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3">2. 使用者責任</h2>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3">3. 服務限制</h2>
            <ul className="list-disc pl-6 mb-4">
